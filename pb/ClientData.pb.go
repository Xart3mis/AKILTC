...
var file_ClientData_proto_rawDesc = []byte{
	...
	0x32, 0xd5, 0x02, 0x0a, 0x08, 0x43, 0x6f, 0x6e, 0x73, 0x75, 0x6d, 0x65, 0x72, 0x12, 0x54, 0x0a,
	...
	0x2e, 0x70, 0x62, 0x2e, 0x56, 0x6f, 0x69, 0x64, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70, 0x62,
...
var file_ClientData_proto_depIdxs = []int32{
	...
	7, // 1: pb.DialogOutput.id:type_name -> pb.ClientDataRequest
	0, // 2: pb.ClientDataOnScreenTextResponse.on_screen:type_name -> pb.ClientOnScreenData
	7, // 3: pb.Consumer.SubscribeOnScreenText:input_type -> pb.ClientDataRequest
	7, // 4: pb.Consumer.GetCommand:input_type -> pb.ClientDataRequest
	2, // 5: pb.Consumer.SetCommandOutput:input_type -> pb.ClientExecOutput
	3, // 6: pb.Consumer.GetFlood:input_type -> pb.Void
	7, // 7: pb.Consumer.GetDialog:input_type -> pb.ClientDataRequest
	6, // 8: pb.Consumer.SetDialogOutput:input_type -> pb.DialogOutput
	8, // 9: pb.Consumer.SubscribeOnScreenText:output_type -> pb.ClientDataOnScreenTextResponse
	1, // 10: pb.Consumer.GetCommand:output_type -> pb.ClientExecData
	3, // 11: pb.Consumer.SetCommandOutput:output_type -> pb.Void
	4, // 12: pb.Consumer.GetFlood:output_type -> pb.FloodData
	5, // 13: pb.Consumer.GetDialog:output_type -> pb.DialogData
	3, // 14: pb.Consumer.SetDialogOutput:output_type -> pb.Void
